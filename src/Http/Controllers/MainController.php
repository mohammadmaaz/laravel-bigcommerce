...
namespace Folio3\LaravelBigcommerceApp\Http\Controllers;
...
class MainController extends BaseController
{
    ...
    public function getAccessToken(Request $request)
    {
        if (env('APP_ENV') === 'local') {
            ...
            return '5m1e5sehtg4gj9l9so1jz4k5sf52gv2';
    ...
    public function makeBigCommerceAPIRequest(Request $request, $endpoint)
    {
        ...
        $response = Http::withHeaders($requestConfig)->$requestMethod('https://api.bigcommerce.com/' . $this->getStoreHash($request) . '/' . $endpoint);
        return $response;
    }
    ...
    public function proxyBigCommerceAPIRequest(Request $request, $endpoint)
    {
        ...
        $response = $this->makeBigCommerceAPIRequest($request, $endpoint);
